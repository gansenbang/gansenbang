...
class Iface:
  ...
  def CommitS4ClusterXMLConfig(self, xmlfile, clustername):
    """
    Parameters:
     - xmlfile
     - clustername
  ...
  def AddS4Server(self, nodeconfig, clustername, s4clustername, adapterclustername):
    """
    Parameters:
     - nodeconfig
     - clustername
  ...
  def AddClientAdapter(self, nodeconfig, clustername, s4clustername, listenappname):
    """
    Parameters:
     - nodeconfig
     - clustername
  ...
  def RemoveS4Node(self, clustername, s4clustername, hostport):
    """
    Parameters:
     - clustername
     - s4clustername
...
class Client(Iface):
  ...
  def CommitS4ClusterXMLConfig(self, xmlfile, clustername):
    ...
    Parameters:
     ...
     - clustername
    """
    self.send_CommitS4ClusterXMLConfig(xmlfile, clustername)
    return self.recv_CommitS4ClusterXMLConfig()

  def send_CommitS4ClusterXMLConfig(self, xmlfile, clustername):
  ...
  def AddS4Server(self, nodeconfig, clustername, s4clustername, adapterclustername):
    ...
    Parameters:
     ...
     - adapterclustername
    """
    self.send_AddS4Server(nodeconfig, clustername, s4clustername, adapterclustername)
    return self.recv_AddS4Server()

  def send_AddS4Server(self, nodeconfig, clustername, s4clustername, adapterclustername):
    self._oprot.writeMessageBegin('AddS4Server', TMessageType.CALL, self._seqid)
    args = AddS4Server_args()
    args.nodeconfig = nodeconfig
    args.clustername = clustername
  ...
  def recv_AddS4Server(self, ):
    ...
    if mtype == TMessageType.EXCEPTION:
      ...
      self._iprot.readMessageEnd()
      raise x
    result = AddS4Server_result()
    result.read(self._iprot)
    self._iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "AddS4Server failed: unknown result");
  ...
  def AddClientAdapter(self, nodeconfig, clustername, s4clustername, listenappname):
    ...
    Parameters:
     ...
     - listenappname
    """
    self.send_AddClientAdapter(nodeconfig, clustername, s4clustername, listenappname)
    return self.recv_AddClientAdapter()

  def send_AddClientAdapter(self, nodeconfig, clustername, s4clustername, listenappname):
    self._oprot.writeMessageBegin('AddClientAdapter', TMessageType.CALL, self._seqid)
    args = AddClientAdapter_args()
    args.nodeconfig = nodeconfig
    args.clustername = clustername
    args.s4clustername = s4clustername
  ...
  def recv_AddClientAdapter(self, ):
    (fname, mtype, rseqid) = self._iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(self._iprot)
      self._iprot.readMessageEnd()
      raise x
    result = AddClientAdapter_result()
    result.read(self._iprot)
    self._iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "AddClientAdapter failed: unknown result");
  ...
  def RemoveS4Node(self, clustername, s4clustername, hostport):
    ...
    Parameters:
     ...
     - hostport
    """
    self.send_RemoveS4Node(clustername, s4clustername, hostport)
    return self.recv_RemoveS4Node()

  def send_RemoveS4Node(self, clustername, s4clustername, hostport):
    self._oprot.writeMessageBegin('RemoveS4Node', TMessageType.CALL, self._seqid)
    args = RemoveS4Node_args()
    args.clustername = clustername
    args.s4clustername = s4clustername
  ...
  def recv_RemoveS4Node(self, ):
    ...
    if mtype == TMessageType.EXCEPTION:
      ...
      self._iprot.readMessageEnd()
      raise x
    result = RemoveS4Node_result()
    result.read(self._iprot)
    self._iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "RemoveS4Node failed: unknown result");
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["AddS4Server"] = Processor.process_AddS4Server
    self._processMap["AddClientAdapter"] = Processor.process_AddClientAdapter
    self._processMap["RemoveS4Node"] = Processor.process_RemoveS4Node
  ...
  def process_CommitS4ClusterXMLConfig(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = CommitS4ClusterXMLConfig_result()
    result.success = self._handler.CommitS4ClusterXMLConfig(args.xmlfile, args.clustername)
    oprot.writeMessageBegin("CommitS4ClusterXMLConfig", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_AddS4Server(self, seqid, iprot, oprot):
    args = AddS4Server_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = AddS4Server_result()
    result.success = self._handler.AddS4Server(args.nodeconfig, args.clustername, args.s4clustername, args.adapterclustername)
    oprot.writeMessageBegin("AddS4Server", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_AddClientAdapter(self, seqid, iprot, oprot):
    args = AddClientAdapter_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = AddClientAdapter_result()
    result.success = self._handler.AddClientAdapter(args.nodeconfig, args.clustername, args.s4clustername, args.listenappname)
    oprot.writeMessageBegin("AddClientAdapter", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_RemoveS4Node(self, seqid, iprot, oprot):
    args = RemoveS4Node_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = RemoveS4Node_result()
    result.success = self._handler.RemoveS4Node(args.clustername, args.s4clustername, args.hostport)
    oprot.writeMessageBegin("RemoveS4Node", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class CommitS4ClusterXMLConfig_args:
  ...
  def __init__(self, xmlfile=None, clustername=None,):
...
class AddS4Server_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'nodeconfig', None, None, ), # 1
    (2, TType.STRING, 'clustername', None, None, ), # 2
    (3, TType.STRING, 's4clustername', None, None, ), # 3
    (4, TType.STRING, 'adapterclustername', None, None, ), # 4
  )

  def __init__(self, nodeconfig=None, clustername=None, s4clustername=None, adapterclustername=None,):
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          self.nodeconfig = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.STRING:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('AddS4Server_args')
    if self.nodeconfig is not None:
      oprot.writeFieldBegin('nodeconfig', TType.STRING, 1)
      oprot.writeString(self.nodeconfig)
      oprot.writeFieldEnd()
    if self.clustername is not None:
      oprot.writeFieldBegin('clustername', TType.STRING, 2)
      oprot.writeString(self.clustername)
    ...
    if self.s4clustername is not None:
      oprot.writeFieldBegin('s4clustername', TType.STRING, 3)
      oprot.writeString(self.s4clustername)
      oprot.writeFieldEnd()
    if self.adapterclustername is not None:
      oprot.writeFieldBegin('adapterclustername', TType.STRING, 4)
...
class AddS4Server_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('AddS4Server_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.BOOL, 0)
      oprot.writeBool(self.success)
      oprot.writeFieldEnd()
...
class AddClientAdapter_args:
  ...
  thrift_spec = (
    ...
    (2, TType.STRING, 'clustername', None, None, ), # 2
    (3, TType.STRING, 's4clustername', None, None, ), # 3
    (4, TType.STRING, 'listenappname', None, None, ), # 4
  )

  def __init__(self, nodeconfig=None, clustername=None, s4clustername=None, listenappname=None,):
    self.nodeconfig = nodeconfig
    self.clustername = clustername
    self.s4clustername = s4clustername
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('AddClientAdapter_args')
    if self.nodeconfig is not None:
      oprot.writeFieldBegin('nodeconfig', TType.STRING, 1)
      oprot.writeString(self.nodeconfig)
      oprot.writeFieldEnd()
    ...
    if self.listenappname is not None:
      oprot.writeFieldBegin('listenappname', TType.STRING, 4)
...
class AddClientAdapter_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('AddClientAdapter_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.BOOL, 0)
      oprot.writeBool(self.success)
      oprot.writeFieldEnd()
...
class RemoveS4Node_args:
  ...
  thrift_spec = (
    ...
    (3, TType.STRING, 'hostport', None, None, ), # 3
  )

  def __init__(self, clustername=None, s4clustername=None, hostport=None,):
    self.clustername = clustername
    self.s4clustername = s4clustername
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('RemoveS4Node_args')
    if self.clustername is not None:
      oprot.writeFieldBegin('clustername', TType.STRING, 1)
      oprot.writeString(self.clustername)
      oprot.writeFieldEnd()
    ...
    if self.hostport is not None:
      oprot.writeFieldBegin('hostport', TType.STRING, 3)
...
class RemoveS4Node_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('RemoveS4Node_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.BOOL, 0)
      oprot.writeBool(self.success)
      oprot.writeFieldEnd()
