...
public class ManagerServer {
  ...
  public interface Iface {
    ...
    public boolean CommitS4ClusterXMLConfig(String xmlfile, String clustername, boolean clean, List<String> s4clustersname) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void CommitS4ClusterXMLConfig(String xmlfile, String clustername, boolean clean, List<String> s4clustersname, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.CommitS4ClusterXMLConfig_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public boolean CommitS4ClusterXMLConfig(String xmlfile, String clustername, boolean clean, List<String> s4clustersname) throws org.apache.thrift.TException
    {
      send_CommitS4ClusterXMLConfig(xmlfile, clustername, clean, s4clustersname);
      return recv_CommitS4ClusterXMLConfig();
    }

    public void send_CommitS4ClusterXMLConfig(String xmlfile, String clustername, boolean clean, List<String> s4clustersname) throws org.apache.thrift.TException
    {
      CommitS4ClusterXMLConfig_args args = new CommitS4ClusterXMLConfig_args();
      args.setXmlfile(xmlfile);
      args.setClustername(clustername);
      args.setClean(clean);
      args.setS4clustersname(s4clustersname);
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void CommitS4ClusterXMLConfig(String xmlfile, String clustername, boolean clean, List<String> s4clustersname, org.apache.thrift.async.AsyncMethodCallback<CommitS4ClusterXMLConfig_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      CommitS4ClusterXMLConfig_call method_call = new CommitS4ClusterXMLConfig_call(xmlfile, clustername, clean, s4clustersname, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class CommitS4ClusterXMLConfig_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private List<String> s4clustersname;
      public CommitS4ClusterXMLConfig_call(String xmlfile, String clustername, boolean clean, List<String> s4clustersname, org.apache.thrift.async.AsyncMethodCallback<CommitS4ClusterXMLConfig_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.xmlfile = xmlfile;
        this.clustername = clustername;
        this.clean = clean;
        this.s4clustersname = s4clustersname;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static class CommitS4ClusterXMLConfig<I extends Iface> extends org.apache.thrift.ProcessFunction<I, CommitS4ClusterXMLConfig_args> {
      ...
      protected CommitS4ClusterXMLConfig_result getResult(I iface, CommitS4ClusterXMLConfig_args args) throws org.apache.thrift.TException {
        CommitS4ClusterXMLConfig_result result = new CommitS4ClusterXMLConfig_result();
        result.success = iface.CommitS4ClusterXMLConfig(args.xmlfile, args.clustername, args.clean, args.s4clustersname);
        result.setSuccessIsSet(true);
        return result;
      }
    }
...
;
  ...
  public static class CommitS4ClusterXMLConfig_args implements org.apache.thrift.TBase<CommitS4ClusterXMLConfig_args, CommitS4ClusterXMLConfig_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static final org.apache.thrift.protocol.TField CLUSTERNAME_FIELD_DESC = new org.apache.thrift.protocol.TField("clustername", org.apache.thrift.protocol.TType.STRING, (short)2);
    private static final org.apache.thrift.protocol.TField CLEAN_FIELD_DESC = new org.apache.thrift.protocol.TField("clean", org.apache.thrift.protocol.TType.BOOL, (short)3);
    private static final org.apache.thrift.protocol.TField S4CLUSTERSNAME_FIELD_DESC = new org.apache.thrift.protocol.TField("s4clustersname", org.apache.thrift.protocol.TType.LIST, (short)4);
    ...
    public String clustername; // required
    public boolean clean; // required
    public List<String> s4clustersname; // required
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      ...
      CLUSTERNAME((short)2, "clustername"),
      CLEAN((short)3, "clean"),
      S4CLUSTERSNAME((short)4, "s4clustersname");
      ...
      public static _Fields findByThriftId(int fieldId) {
        switch(fieldId) {
          ...
          case 3: // CLEAN
            return CLEAN;
          case 4: // S4CLUSTERSNAME
            return S4CLUSTERSNAME;
          default:
            return null;
        }
      }
    ...
    // isset id assignments
    private static final int __CLEAN_ISSET_ID = 0;
    private BitSet __isset_bit_vector = new BitSet(1);
    public static final Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      ...
      tmpMap.put(_Fields.CLUSTERNAME, new org.apache.thrift.meta_data.FieldMetaData("clustername", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
      tmpMap.put(_Fields.CLEAN, new org.apache.thrift.meta_data.FieldMetaData("clean", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
      tmpMap.put(_Fields.S4CLUSTERSNAME, new org.apache.thrift.meta_data.FieldMetaData("s4clustersname", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public CommitS4ClusterXMLConfig_args(CommitS4ClusterXMLConfig_args other) {
      ...
      if (other.isSetS4clustersname()) {
        List<String> __this__s4clustersname = new ArrayList<String>();
        for (String other_element : other.s4clustersname) {
          __this__s4clustersname.add(other_element);
        }
        this.s4clustersname = __this__s4clustersname;
      }
    }
    ...
    public CommitS4ClusterXMLConfig_args setClean(boolean clean) {
      this.clean = clean;
      setCleanIsSet(true);
      return this;
    }
    ...
    public void unsetClean() {
      __isset_bit_vector.clear(__CLEAN_ISSET_ID);
    }

    /** Returns true if field clean is set (has been assigned a value) and false otherwise */
    public boolean isSetClean() {
      return __isset_bit_vector.get(__CLEAN_ISSET_ID);
    }

    public void setCleanIsSet(boolean value) {
      __isset_bit_vector.set(__CLEAN_ISSET_ID, value);
    }

    public int getS4clustersnameSize() {
      return (this.s4clustersname == null) ? 0 : this.s4clustersname.size();
    }

    public java.util.Iterator<String> getS4clustersnameIterator() {
      return (this.s4clustersname == null) ? null : this.s4clustersname.iterator();
    }

    public void addToS4clustersname(String elem) {
      if (this.s4clustersname == null) {
        this.s4clustersname = new ArrayList<String>();
      }
      this.s4clustersname.add(elem);
    }

    public List<String> getS4clustersname() {
      return this.s4clustersname;
    }

    public CommitS4ClusterXMLConfig_args setS4clustersname(List<String> s4clustersname) {
      this.s4clustersname = s4clustersname;
      return this;
    }

    public void unsetS4clustersname() {
      this.s4clustersname = null;
    }

    /** Returns true if field s4clustersname is set (has been assigned a value) and false otherwise */
    public boolean isSetS4clustersname() {
      return this.s4clustersname != null;
    }

    public void setS4clustersnameIsSet(boolean value) {
      if (!value) {
        this.s4clustersname = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case S4CLUSTERSNAME:
        if (value == null) {
          ...
          setS4clustersname((List<String>)value);
        }
        break;
    ...
    public boolean equals(CommitS4ClusterXMLConfig_args that) {
      ...
      boolean this_present_clean = true;
      boolean that_present_clean = true;
      if (this_present_clean || that_present_clean) {
        if (!(this_present_clean && that_present_clean))
          return false;
        if (this.clean != that.clean)
          return false;
      }

      boolean this_present_s4clustersname = true && this.isSetS4clustersname();
      boolean that_present_s4clustersname = true && that.isSetS4clustersname();
      if (this_present_s4clustersname || that_present_s4clustersname) {
        if (!(this_present_s4clustersname && that_present_s4clustersname))
          return false;
        if (!this.s4clustersname.equals(that.s4clustersname))
          return false;
      }
    ...
    public int compareTo(CommitS4ClusterXMLConfig_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetClean()).compareTo(typedOther.isSetClean());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetClean()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.clean, typedOther.clean);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
      lastComparison = Boolean.valueOf(isSetS4clustersname()).compareTo(typedOther.isSetS4clustersname());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetS4clustersname()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.s4clustersname, typedOther.s4clustersname);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      if (!first) sb.append(", ");
      sb.append("clean:");
      sb.append(this.clean);
      first = false;
      if (!first) sb.append(", ");
      sb.append("s4clustersname:");
      if (this.s4clustersname == null) {
        sb.append("null");
      } else {
        sb.append(this.s4clustersname);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class CommitS4ClusterXMLConfig_argsStandardScheme extends StandardScheme<CommitS4ClusterXMLConfig_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, CommitS4ClusterXMLConfig_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 3: // CLEAN
              if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
                struct.clean = iprot.readBool();
                struct.setCleanIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.s4clustersname = new ArrayList<String>(_list24.size);
                  for (int _i25 = 0; _i25 < _list24.size; ++_i25)
                  {
                    String _elem26; // required
                    _elem26 = iprot.readString();
                    struct.s4clustersname.add(_elem26);
                  }
                  iprot.readListEnd();
                }
                struct.setS4clustersnameIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, CommitS4ClusterXMLConfig_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeFieldBegin(CLEAN_FIELD_DESC);
        oprot.writeBool(struct.clean);
        oprot.writeFieldEnd();
        if (struct.s4clustersname != null) {
          oprot.writeFieldBegin(S4CLUSTERSNAME_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, struct.s4clustersname.size()));
            for (String _iter27 : struct.s4clustersname)
            {
    ...
    private static class CommitS4ClusterXMLConfig_argsTupleScheme extends TupleScheme<CommitS4ClusterXMLConfig_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, CommitS4ClusterXMLConfig_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetClean()) {
          optionals.set(2);
        }
        if (struct.isSetS4clustersname()) {
          optionals.set(3);
        }
        ...
        if (struct.isSetS4clustersname()) {
          {
            oprot.writeI32(struct.s4clustersname.size());
            for (String _iter28 : struct.s4clustersname)
            {
        ...
        if (incoming.get(3)) {
          {
            ...
            struct.s4clustersname = new ArrayList<String>(_list29.size);
            for (int _i30 = 0; _i30 < _list29.size; ++_i30)
            {
              String _elem31; // required
              _elem31 = iprot.readString();
              struct.s4clustersname.add(_elem31);
            }
          }
          struct.setS4clustersnameIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.success = new HashMap<String,Map<String,String>>(2*_map32.size);
                  for (int _i33 = 0; _i33 < _map32.size; ++_i33)
                  {
                    String _key34; // required
                    Map<String,String> _val35; // required
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, GetS4ClusterMessage_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Map<String,String>> _iter40 : struct.success.entrySet())
            {
              oprot.writeString(_iter40.getKey());
              {
                oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, _iter40.getValue().size()));
                for (Map.Entry<String, String> _iter41 : _iter40.getValue().entrySet())
                {
    ...
    private static class GetS4ClusterMessage_resultTupleScheme extends TupleScheme<GetS4ClusterMessage_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, GetS4ClusterMessage_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (Map.Entry<String, Map<String,String>> _iter42 : struct.success.entrySet())
            {
              oprot.writeString(_iter42.getKey());
              {
                oprot.writeI32(_iter42.getValue().size());
                for (Map.Entry<String, String> _iter43 : _iter42.getValue().entrySet())
                {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, GetS4ClusterMessage_result struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TMap _map44 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.MAP, iprot.readI32());
            struct.success = new HashMap<String,Map<String,String>>(2*_map44.size);
            for (int _i45 = 0; _i45 < _map44.size; ++_i45)
            {
              String _key46; // required
              Map<String,String> _val47; // required
              _key46 = iprot.readString();
              {
                ...
                _val47 = new HashMap<String,String>(2*_map48.size);
