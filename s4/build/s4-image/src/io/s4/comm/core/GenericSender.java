...
public class GenericSender {
	...
	public GenericSender(String zkAddress, String adapterClusterName,
		...
		try {
			...
			listenerMonitor = CommServiceFactory.getProcessMonitor(this.zkAddress, s4ClusterName, callbackHandler);
	...
	public GenericSender(String zkAddress, String senderAppName,
		...
		this(zkAddress, senderAppName, listenerAppName, senderConfigData,
				new GenericSerDeser());
	}
	...
	public boolean send(Object data) {
		try {
			...
			Map<String, String> dest = (Map<String, String>) destinationList
					.get(Math.abs(index));
	...
	public boolean sendUsingHashCode(int hashcode, Object data) {
		int partition = (hashcode & Integer.MAX_VALUE) % getListenerTaskCount();
	...
	public int getListenerTaskCount() {
		...
		return listenerMonitor.getTaskCount();
	}
