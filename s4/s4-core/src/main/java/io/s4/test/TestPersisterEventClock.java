...
public class TestPersisterEventClock {
    ...
    public void testPersister(Persister persister) {
        ...
        if (persister instanceof HashMapPersister) {
            ...
            try {
                waitfortime = s4Clock.waitForTime(s4Clock.getCurrentTime() + 1);
            ...
            try {
                waitfortime = s4Clock.waitForTime(s4Clock.getCurrentTime() + 41000);
                System.out.println(waitfortime);
            } catch (Exception e) {
            }
        ...
        if (persister instanceof ConMapPersister) {
            ...
            try {
                waitfortime = s4Clock.waitForTime(s4Clock.getCurrentTime() + 1);
                System.out.println(waitfortime);
                waitfortime = s4Clock.waitForTime(s4Clock.getCurrentTime() + 2);
                System.out.println(waitfortime);
            } catch (Exception e) {
            }
            ...
            System.out.println("Going to sleep...");
            try {
                waitfortime = s4Clock.waitForTime(s4Clock.getCurrentTime() + 10000);
                System.out.println(waitfortime);
            } catch (Exception e) {
            }
            System.out.println("Waking up");
