...
public class StaticTaskManager implements TaskManager {
	...
	private void readStaticConfig() {
		...
		List<Map<String, String>> processList = ConfigUtils.readConfig(
				"clusters.xml", clusterName, clusterType, true);
	...
	public boolean cleanUp() {
		throw new UnsupportedOperationException(
				"cleanUp Not supported in red button mode");
	}
	...
	public void setUpTasks(int numTasks, Object[] data) {
		throw new UnsupportedOperationException(
				"setUpTasks Not supported in red button mode");
	}
	...
	private boolean takeProcess(Map<String, String> processConfig) {
		...
		try {
			...
			logger.error(
					"Exception trying to take up process:" + processConfig, e);
		} finally {
			if (lockFile != null) {
